...
export default async function Page({ params }: PageProps) {
  ...
  <div className="min-h-screen bg-gray-950 text-white px-4 sm:px-6 py-8 sm:py-12">
    ...
    <div className="flex flex-col items-center mb-10">
      ...
      <h1 className="text-3xl sm:text-4xl font-bold text-green-400 text-center">
          {"<Gu3ss/>"}
      </h1>

      <p className="text-base sm:text-lg text-gray-400 mt-2 text-center capitalize">
        {category}
      </p>
    </div>
  ...
  className="
    group
    flex flex-col sm:flex-row justify-between items-center sm:items-start gap-4
...
>
  <div className="flex-1">
    ...
    {quiz.description && (
      <p className="text-gray-400 mt-1 text-sm sm:text-base max-w-md mx-auto sm:mx-0">
        {quiz.description}
      </p>
    )}
  </div>
